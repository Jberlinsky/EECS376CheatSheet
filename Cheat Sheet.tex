\documentclass[8pt,landscape,legalpaper]{article}
...
{\bf Projection:} Think of projection like a shadow, so $\{A x B x C\}$ projected with $\{A x C\}$ yields $\{A x C\}$. It can also be considered the intersection where all elements in both sets will be present in the new set.
